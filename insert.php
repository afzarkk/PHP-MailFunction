...
if (isset($_POST['submit'])) {
    ...
    if ($imageexist) {
        ...
        if (move_uploaded_file($tempname, $folder)) {
            $sql = "INSERT INTO `data`(`Name`, `Email`, `Dob`, `Age`, `Gender`, `Language`, `Phone_no`, `Address`, `City`, `Image`) VALUES ('$name', '$email', '$dob', '$age', '$gender', '$language', '$phonenumber', '$address', '$city', '$folder');";
            mysqli_query($conn, $sql);
            $smptp_mail = Mailfuntion($name, $email, $dob, $age, $gender, $language, $phonenumber, $address, $city, $folder);
            echo $smptp_mail;
