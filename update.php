...
if (isset($_POST['update'])) {
    ...
    if (!empty($filename)) {
        if (move_uploaded_file($tempname, $folder)) {
            ...
            $sql = "UPDATE `data` SET `Name`='$name', `Email`='$email', `Dob`='$dob', `Age`='$age', `Gender`='$gender', `Language`='$language', `Phone_no`='$phonenumber', `Address`='$address', `City`='$city' , `Image`='$folder' WHERE id='$id'";
        } else {
            // File upload failed
        ...
        $sql = "UPDATE `data` SET `Name`='$name', `Email`='$email', `Dob`='$dob', `Age`='$age', `Gender`='$gender', `Language`='$language', `Phone_no`='$phonenumber', `Address`='$address', `City`='$city' WHERE id='$id'";
    }
